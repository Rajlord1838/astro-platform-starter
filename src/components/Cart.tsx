    ...
    return (
        <>
            <button
                ...
                className="relative p-2 text-gray-200 transition-colors rounded-full hover:bg-gray-800"
            >
            ...
            {isOpen && (
                <div className="fixed inset-0 z-50 overflow-hidden bg-black/50" onClick={() => setIsOpen(false)}>
                    <div className="absolute inset-y-0 right-0 flex max-w-full pl-10" onClick={(e) => e.stopPropagation()}>
                        <div className="w-screen max-w-md">
                            <div className="flex flex-col h-full bg-white shadow-xl">
                                        ...
                                        <ul role="list" className="-my-6 divide-y divide-gray-200">
                                            {cartItems.map((item) => (
                                                <li key={item.product.id} className="flex py-6">
                                                    ...
                                                    <div className="flex flex-col flex-1 ml-4 text-gray-900">
                                                        <div>
                                ...
                                {cartItems.length > 0 && (
                                    <div className="px-4 py-6 border-t border-gray-200 sm:px-6 bg-gray-50 text-gray-900">
                                        <div className="flex justify-between text-base font-medium">
                                            <p>Subtotal</p>
                                        ...
                                        <div className="mt-6">
                                            <a
                                                href="#"
                                                className="flex items-center justify-center px-6 py-3 text-base font-medium text-white border border-transparent rounded-md shadow-sm bg-primary hover:bg-primary/90"
                                            >
                                                Checkout
                                            </a>
                                        </div>
